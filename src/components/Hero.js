        ...
        <div className="grid gap-8 py-16 sm:py-24 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-xl text-slate-600">
              We advance socio-hydro-climate understanding and co-create innovative approaches to build a sustainable and resilient future for water, climate, and society.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#scope" className="rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700">Explore research</a>
              <a href="#milestones" className="rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">See roadmap</a>
            </div>
          </div>
