...
export default function Header() {
  ...
  const NavLinks = ({ onClick }) => (
    <>
      <Link href="/#about" onClick={onClick} className="hover:text-emerald-700">About</Link>
      <Link href="/#vision" onClick={onClick} className="hover:text-emerald-700">Vision</Link>
      <Link href="/#scope" onClick={onClick} className="hover:text-emerald-700">Research</Link>
      <Link href="/#milestones" onClick={onClick} className="hover:text-emerald-700">Milestones</Link>
      <Link href="/#team" onClick={onClick} className="hover:text-emerald-700">Team</Link>
      <Link href="/#contact" onClick={onClick} className="hover:text-emerald-700">Contact</Link>
      <Link href="/articles" onClick={onClick} className="hover:text-emerald-700">Articles</Link>
    </>
  );
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200/60 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      ...
      {/* Mobile sheet */}
      <div
        className={`sm:hidden fixed inset-0 z-50 transition ${open ? "pointer-events-auto" : "pointer-events-none"}`}
        aria-hidden={!open}
      >
        {/* Backdrop */}
        <div
        ...
        >
          ...
          <nav className="flex flex-col gap-3 p-4 text-sm font-medium text-slate-700 bg-white">
